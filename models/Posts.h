...
class Posts
{
  public:
    struct Cols
    {
        ...
        static const std::string _updated;
    };
    ...
    void setCreatedToNull() noexcept;

    /**  For column updated  */
    ///Get the value of the column updated, returns the default value if the column is null
    const ::trantor::Date &getValueOfUpdated() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<::trantor::Date> &getUpdated() const noexcept;
    ///Set the value of the column updated
    void setUpdated(const ::trantor::Date &pUpdated) noexcept;
    void setUpdatedToNull() noexcept;
  ...
  private:
    ...
    std::shared_ptr<::trantor::Date> updated_;
    struct MetaData
    {
